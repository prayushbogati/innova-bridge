...
export default function ContactForm() {
    ...
    return (
        <form>
            <div className="flex flex-col lg:grid grid-cols-2 gap-y-3 gap-x-5">
            ...
            <button type="submit" className="bg-indigo-800 hover:bg-indigo-700 text-white p-3 w-full rounded-md text-sm my-3">Send Message</button>
