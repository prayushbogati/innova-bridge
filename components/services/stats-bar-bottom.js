...
export default function StatsBarBottom() {
    ...
    return (
        <div className="max-lg:hidden absolute flex flex-row items-center justify-center gap-5 md:gap-10 p-2 bg-white text-black rounded-xl text-xl border border-gray-300">
            {
                stats.map(stat => (
